...
const Main = () => {
  return (
    <section
      id="home"
      className={`flex md:flex-row flex-col ${styles.paddingY} max-w-[1200px] mx-auto`}
    >
      <div
      ...
      >
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[64px] text-[48px] text-white ss:leading-[100.8px] leading-[75px]">
            Cerberus<br className="sm:block hidden" />{" "}
            <span className="text-gradient">Blu's Hacks</span>{" "}
          </h1>
        </div>
        <p className={`${styles.paragraph} max-w-[500px] mt-5`}>
          Promoting financial security in emails and more with email fraud,
